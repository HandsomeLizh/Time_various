...
irt_nav_msgs__msg__SimulationTime__init(irt_nav_msgs__msg__SimulationTime * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    irt_nav_msgs__msg__SimulationTime__fini(msg);
    return false;
  }
  // sim_time
  return true;
...
irt_nav_msgs__msg__SimulationTime__create()
{
  ...
  irt_nav_msgs__msg__SimulationTime * msg = (irt_nav_msgs__msg__SimulationTime *)allocator.allocate(sizeof(irt_nav_msgs__msg__SimulationTime), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(irt_nav_msgs__msg__SimulationTime));
  bool success = irt_nav_msgs__msg__SimulationTime__init(msg);
  if (!success) {
...
irt_nav_msgs__msg__SimulationTime__Sequence__init(irt_nav_msgs__msg__SimulationTime__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irt_nav_msgs__msg__SimulationTime * data = NULL;

  if (size) {
    data = (irt_nav_msgs__msg__SimulationTime *)allocator.zero_allocate(size, sizeof(irt_nav_msgs__msg__SimulationTime), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = irt_nav_msgs__msg__SimulationTime__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        irt_nav_msgs__msg__SimulationTime__fini(&data[i - 1]);
      }
...
irt_nav_msgs__msg__SimulationTime__Sequence__fini(irt_nav_msgs__msg__SimulationTime__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      irt_nav_msgs__msg__SimulationTime__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  irt_nav_msgs__msg__SimulationTime__Sequence * array = (irt_nav_msgs__msg__SimulationTime__Sequence *)allocator.allocate(sizeof(irt_nav_msgs__msg__SimulationTime__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = irt_nav_msgs__msg__SimulationTime__Sequence__init(array, size);
  if (!success) {
...
irt_nav_msgs__msg__SimulationTime__Sequence__destroy(irt_nav_msgs__msg__SimulationTime__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    irt_nav_msgs__msg__SimulationTime__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
irt_nav_msgs__msg__SimulationTime__Sequence__are_equal(const irt_nav_msgs__msg__SimulationTime__Sequence * lhs, const irt_nav_msgs__msg__SimulationTime__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!irt_nav_msgs__msg__SimulationTime__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  irt_nav_msgs__msg__SimulationTime__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(irt_nav_msgs__msg__SimulationTime);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    irt_nav_msgs__msg__SimulationTime * data =
      (irt_nav_msgs__msg__SimulationTime *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irt_nav_msgs__msg__SimulationTime__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          irt_nav_msgs__msg__SimulationTime__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!irt_nav_msgs__msg__SimulationTime__copy(
