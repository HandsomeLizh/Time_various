...
#ifndef IRT_NAV_MSGS__MSG__DETAIL__GAUSSIAN_MIXTURE__TRAITS_HPP_
#define IRT_NAV_MSGS__MSG__DETAIL__GAUSSIAN_MIXTURE__TRAITS_HPP_
...
inline std::string to_yaml(const GaussianMixture & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const irt_nav_msgs::msg::GaussianMixture & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const irt_nav_msgs::msg::GaussianMixture & msg)
{
  return irt_nav_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<irt_nav_msgs::msg::GaussianMixture>()
{
  return "irt_nav_msgs::msg::GaussianMixture";
}

template<>
inline const char * name<irt_nav_msgs::msg::GaussianMixture>()
{
  return "irt_nav_msgs/msg/GaussianMixture";
}

template<>
struct has_fixed_size<irt_nav_msgs::msg::GaussianMixture>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<irt_nav_msgs::msg::GaussianMixture>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<irt_nav_msgs::msg::GaussianMixture>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // IRT_NAV_MSGS__MSG__DETAIL__GAUSSIAN_MIXTURE__TRAITS_HPP_
