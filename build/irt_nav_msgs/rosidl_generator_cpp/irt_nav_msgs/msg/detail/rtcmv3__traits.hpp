...
#ifndef IRT_NAV_MSGS__MSG__DETAIL__RTCMV3__TRAITS_HPP_
#define IRT_NAV_MSGS__MSG__DETAIL__RTCMV3__TRAITS_HPP_
...
inline std::string to_yaml(const RTCMV3 & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const irt_nav_msgs::msg::RTCMV3 & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const irt_nav_msgs::msg::RTCMV3 & msg)
{
  return irt_nav_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<irt_nav_msgs::msg::RTCMV3>()
{
  return "irt_nav_msgs::msg::RTCMV3";
}

template<>
inline const char * name<irt_nav_msgs::msg::RTCMV3>()
{
  return "irt_nav_msgs/msg/RTCMV3";
}

template<>
struct has_fixed_size<irt_nav_msgs::msg::RTCMV3>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<irt_nav_msgs::msg::RTCMV3>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<irt_nav_msgs::msg::RTCMV3>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // IRT_NAV_MSGS__MSG__DETAIL__RTCMV3__TRAITS_HPP_
