...
class Metaclass_CorrevitVelAngle(type):
    """Metaclass of message 'CorrevitVelAngle'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'irt_nav_msgs.msg.CorrevitVelAngle')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__correvit_vel_angle
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__correvit_vel_angle
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__correvit_vel_angle
            cls._TYPE_SUPPORT = module.type_support_msg__msg__correvit_vel_angle
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__correvit_vel_angle
...
class CorrevitVelAngle(metaclass=Metaclass_CorrevitVelAngle):
    """Message class 'CorrevitVelAngle'."""
