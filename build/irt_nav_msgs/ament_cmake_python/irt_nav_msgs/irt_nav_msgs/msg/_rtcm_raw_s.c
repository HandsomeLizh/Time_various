...
bool irt_nav_msgs__msg__rtcm_raw__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("irt_nav_msgs.msg._rtcm_raw.RTCMRaw", full_classname_dest, 34) == 0);
  }
  irt_nav_msgs__msg__RTCMRaw * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RTCMRaw */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("irt_nav_msgs.msg._rtcm_raw");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RTCMRaw");
