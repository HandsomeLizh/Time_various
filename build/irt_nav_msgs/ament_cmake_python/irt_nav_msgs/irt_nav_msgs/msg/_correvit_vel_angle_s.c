...
bool irt_nav_msgs__msg__correvit_vel_angle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("irt_nav_msgs.msg._correvit_vel_angle.CorrevitVelAngle", full_classname_dest, 53) == 0);
  }
  irt_nav_msgs__msg__CorrevitVelAngle * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of CorrevitVelAngle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("irt_nav_msgs.msg._correvit_vel_angle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CorrevitVelAngle");
