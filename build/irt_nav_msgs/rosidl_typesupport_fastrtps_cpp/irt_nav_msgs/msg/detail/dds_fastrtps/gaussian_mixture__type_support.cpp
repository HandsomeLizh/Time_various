...
#include "irt_nav_msgs/msg/detail/gaussian_mixture__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const irt_nav_msgs::msg::GaussianMixture & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  irt_nav_msgs::msg::GaussianMixture & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_irt_nav_msgs
max_serialized_size_GaussianMixture(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irt_nav_msgs::msg::GaussianMixture;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const irt_nav_msgs::msg::GaussianMixture *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<irt_nav_msgs::msg::GaussianMixture *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GaussianMixture__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const irt_nav_msgs::msg::GaussianMixture *>(
...
static size_t _GaussianMixture__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GaussianMixture(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GaussianMixture__callbacks = {
  "irt_nav_msgs::msg",
  "GaussianMixture",
...
static rosidl_message_type_support_t _GaussianMixture__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GaussianMixture__callbacks,
...
{
  return &irt_nav_msgs::msg::typesupport_fastrtps_cpp::_GaussianMixture__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irt_nav_msgs, msg, GaussianMixture)() {
  return &irt_nav_msgs::msg::typesupport_fastrtps_cpp::_GaussianMixture__handle;
}
