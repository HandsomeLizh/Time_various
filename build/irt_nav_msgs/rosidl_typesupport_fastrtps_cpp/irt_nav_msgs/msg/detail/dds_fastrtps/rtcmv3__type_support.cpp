...
#include "irt_nav_msgs/msg/detail/rtcmv3__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const irt_nav_msgs::msg::RTCMV3 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  irt_nav_msgs::msg::RTCMV3 & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irt_nav_msgs::msg::RTCMV3;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const irt_nav_msgs::msg::RTCMV3 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<irt_nav_msgs::msg::RTCMV3 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RTCMV3__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const irt_nav_msgs::msg::RTCMV3 *>(
...
static size_t _RTCMV3__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RTCMV3(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RTCMV3__callbacks = {
  "irt_nav_msgs::msg",
  "RTCMV3",
...
static rosidl_message_type_support_t _RTCMV3__handle = {
...
{
  return &irt_nav_msgs::msg::typesupport_fastrtps_cpp::_RTCMV3__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irt_nav_msgs, msg, RTCMV3)() {
  return &irt_nav_msgs::msg::typesupport_fastrtps_cpp::_RTCMV3__handle;
}
