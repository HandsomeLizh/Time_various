...
#include "irt_nav_msgs/msg/detail/elapsed_time_fgo__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const irt_nav_msgs::msg::ElapsedTimeFGO & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  irt_nav_msgs::msg::ElapsedTimeFGO & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_irt_nav_msgs
max_serialized_size_ElapsedTimeFGO(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irt_nav_msgs::msg::ElapsedTimeFGO;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const irt_nav_msgs::msg::ElapsedTimeFGO *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<irt_nav_msgs::msg::ElapsedTimeFGO *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ElapsedTimeFGO__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const irt_nav_msgs::msg::ElapsedTimeFGO *>(
...
static size_t _ElapsedTimeFGO__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ElapsedTimeFGO(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ElapsedTimeFGO__callbacks = {
  "irt_nav_msgs::msg",
  "ElapsedTimeFGO",
...
static rosidl_message_type_support_t _ElapsedTimeFGO__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ElapsedTimeFGO__callbacks,
...
{
  return &irt_nav_msgs::msg::typesupport_fastrtps_cpp::_ElapsedTimeFGO__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irt_nav_msgs, msg, ElapsedTimeFGO)() {
  return &irt_nav_msgs::msg::typesupport_fastrtps_cpp::_ElapsedTimeFGO__handle;
}
