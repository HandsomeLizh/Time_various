...
class Metaclass_RTCML1E1(type):
    """Metaclass of message 'RTCML1E1'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'irt_nav_msgs.msg.RTCML1E1')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__rtcml1_e1
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__rtcml1_e1
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__rtcml1_e1
            cls._TYPE_SUPPORT = module.type_support_msg__msg__rtcml1_e1
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__rtcml1_e1
...
class RTCML1E1(metaclass=Metaclass_RTCML1E1):
    """Message class 'RTCML1E1'."""
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('double'), 40),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('uint8'), 40),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('double'), 40),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('double'), 40),  # noqa: E501
    ...
    def pseudorange(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 40, \
                "The 'pseudorange' numpy.ndarray() must have a size of 40"
    ...
    def type(self, value):  # noqa: A003
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 40, \
                "The 'type' numpy.ndarray() must have a size of 40"
            self._type = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= 0 and val < 256 for val in value)), \
                "The 'type' field must be a set or sequence with length 40 and each value of type 'int' and each unsigned integer in [0, 255]"
    ...
    def carrier(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 40, \
                "The 'carrier' numpy.ndarray() must have a size of 40"
            self._carrier = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'carrier' field must be a set or sequence with length 40 and each value of type 'float' and each double in [-.000000, .000000]"
    ...
    def cn0(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 40, \
                "The 'cn0' numpy.ndarray() must have a size of 40"
            self._cn0 = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'cn0' field must be a set or sequence with length 40 and each value of type 'float' and each double in [-.000000, .000000]"
    ...
    def locktime(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 40, \
                "The 'locktime' numpy.ndarray() must have a size of 40"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'locktime' field must be a set or sequence with length 40 and each value of type 'int' and each unsigned integer in [0, 65535]"
    ...
    def lli(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 40, \
                "The 'lli' numpy.ndarray() must have a size of 40"
            self._lli = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= 0 and val < 65536 for val in value)), \
                "The 'lli' field must be a set or sequence with length 40 and each value of type 'int' and each unsigned integer in [0, 65535]"
