...
bool irt_nav_msgs__msg__gnss_correction__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("irt_nav_msgs.msg._gnss_correction.GNSSCorrection", full_classname_dest, 48) == 0);
  }
  irt_nav_msgs__msg__GNSSCorrection * ros_message = _ros_message;
  {  // prn
    ...
    ros_message->prn = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // psr_correction
...
{
  /* NOTE(esteve): Call constructor of GNSSCorrection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("irt_nav_msgs.msg._gnss_correction");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GNSSCorrection");
