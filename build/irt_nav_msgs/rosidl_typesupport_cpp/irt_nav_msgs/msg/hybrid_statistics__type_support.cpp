...
static const _HybridStatistics_type_support_symbol_names_t _HybridStatistics_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irt_nav_msgs, msg, HybridStatistics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irt_nav_msgs, msg, HybridStatistics)),
  }
};
...
{
  return &::irt_nav_msgs::msg::rosidl_typesupport_cpp::HybridStatistics_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, irt_nav_msgs, msg, HybridStatistics)() {
  return get_message_type_support_handle<irt_nav_msgs::msg::HybridStatistics>();
}
