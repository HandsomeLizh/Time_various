...
#include "irt_nav_msgs/msg/detail/gaussian_mixture__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // residuals
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // residuals
#include "rosidl_runtime_c/string.h"  // environment, factor
#include "rosidl_runtime_c/string_functions.h"  // environment, factor
...
using _GaussianMixture__ros_msg_type = irt_nav_msgs__msg__GaussianMixture;

static bool _GaussianMixture__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GaussianMixture__ros_msg_type * ros_message = static_cast<const _GaussianMixture__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _GaussianMixture__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _GaussianMixture__ros_msg_type * ros_message = static_cast<_GaussianMixture__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_irt_nav_msgs__msg__GaussianMixture(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GaussianMixture__ros_msg_type * ros_message = static_cast<const _GaussianMixture__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GaussianMixture__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_irt_nav_msgs__msg__GaussianMixture(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_irt_nav_msgs
size_t max_serialized_size_irt_nav_msgs__msg__GaussianMixture(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irt_nav_msgs__msg__GaussianMixture;
    is_plain =
      (
      offsetof(DataType, gaussian) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _GaussianMixture__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_irt_nav_msgs__msg__GaussianMixture(
...
static message_type_support_callbacks_t __callbacks_GaussianMixture = {
  "irt_nav_msgs::msg",
  "GaussianMixture",
  _GaussianMixture__cdr_serialize,
  _GaussianMixture__cdr_deserialize,
  _GaussianMixture__get_serialized_size,
  _GaussianMixture__max_serialized_size
};

static rosidl_message_type_support_t _GaussianMixture__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GaussianMixture,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irt_nav_msgs, msg, GaussianMixture)() {
  return &_GaussianMixture__type_support;
}
