...
#include "irt_nav_msgs/msg/detail/gnss_labeling__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // ant_pos, ant_vel, gt_pos, gt_vel
#include "irt_nav_msgs/msg/detail/sat_label__functions.h"  // ant_aux_labels, ant_main_labels
...
#include "rosidl_runtime_c/string.h"  // environment
#include "rosidl_runtime_c/string_functions.h"  // environment
...
using _GNSSLabeling__ros_msg_type = irt_nav_msgs__msg__GNSSLabeling;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GNSSLabeling__ros_msg_type * ros_message = static_cast<const _GNSSLabeling__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: related_state_timestamp_nanosec
  {
  ...
  // Field name: ant_main_labels
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, irt_nav_msgs, msg, SatLabel
      )()->data);
    size_t size = ros_message->ant_main_labels.size;
    auto array_ptr = ros_message->ant_main_labels.data;
  ...
  // Field name: ant_aux_labels
  {
    ...
    auto array_ptr = ros_message->ant_aux_labels.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  // Field name: gt_vel
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->gt_vel, cdr))
    {
      return false;
    }
  }

  // Field name: clock_bias
  {
    cdr << ros_message->clock_bias;
  }

  // Field name: clock_drift
  {
    cdr << ros_message->clock_drift;
  }

  // Field name: gt_clock_bias
  {
    cdr << ros_message->gt_clock_bias;
  }

  // Field name: gt_clock_drift
  {
  ...
  void * untyped_ros_message)
{
  ...
  _GNSSLabeling__ros_msg_type * ros_message = static_cast<_GNSSLabeling__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: ant_main_labels
  {
    ...
    if (ros_message->ant_main_labels.data) {
      irt_nav_msgs__msg__SatLabel__Sequence__fini(&ros_message->ant_main_labels);
    }
    if (!irt_nav_msgs__msg__SatLabel__Sequence__init(&ros_message->ant_main_labels, size)) {
      fprintf(stderr, "failed to create array for field 'ant_main_labels'");
      return false;
    }
    auto array_ptr = ros_message->ant_main_labels.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: ant_aux_labels
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->ant_aux_labels.data) {
      irt_nav_msgs__msg__SatLabel__Sequence__fini(&ros_message->ant_aux_labels);
    }
    if (!irt_nav_msgs__msg__SatLabel__Sequence__init(&ros_message->ant_aux_labels, size)) {
      fprintf(stderr, "failed to create array for field 'ant_aux_labels'");
      return false;
    }
    auto array_ptr = ros_message->ant_aux_labels.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_irt_nav_msgs__msg__GNSSLabeling(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GNSSLabeling__ros_msg_type * ros_message = static_cast<const _GNSSLabeling__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name ant_main_labels
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_irt_nav_msgs__msg__SatLabel(
...
static uint32_t _GNSSLabeling__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_irt_nav_msgs__msg__GNSSLabeling(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_irt_nav_msgs
size_t max_serialized_size_irt_nav_msgs__msg__GNSSLabeling(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: ant_main_labels
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_irt_nav_msgs__msg__SatLabel(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = irt_nav_msgs__msg__GNSSLabeling;
    is_plain =
      (
...
static size_t _GNSSLabeling__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_irt_nav_msgs__msg__GNSSLabeling(
...
static message_type_support_callbacks_t __callbacks_GNSSLabeling = {
  "irt_nav_msgs::msg",
  "GNSSLabeling",
...
static rosidl_message_type_support_t _GNSSLabeling__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GNSSLabeling,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irt_nav_msgs, msg, GNSSLabeling)() {
  return &_GNSSLabeling__type_support;
}
