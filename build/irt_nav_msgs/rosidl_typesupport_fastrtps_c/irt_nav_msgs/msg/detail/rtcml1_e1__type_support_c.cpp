...
#include "irt_nav_msgs/msg/detail/rtcml1_e1__rosidl_typesupport_fastrtps_c.h"
...
using _RTCML1E1__ros_msg_type = irt_nav_msgs__msg__RTCML1E1;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RTCML1E1__ros_msg_type * ros_message = static_cast<const _RTCML1E1__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RTCML1E1__ros_msg_type * ros_message = static_cast<_RTCML1E1__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_irt_nav_msgs__msg__RTCML1E1(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RTCML1E1__ros_msg_type * ros_message = static_cast<const _RTCML1E1__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RTCML1E1__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_irt_nav_msgs__msg__RTCML1E1(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_irt_nav_msgs
size_t max_serialized_size_irt_nav_msgs__msg__RTCML1E1(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irt_nav_msgs__msg__RTCML1E1;
    is_plain =
      (
...
static size_t _RTCML1E1__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_irt_nav_msgs__msg__RTCML1E1(
...
static message_type_support_callbacks_t __callbacks_RTCML1E1 = {
  "irt_nav_msgs::msg",
  "RTCML1E1",
...
static rosidl_message_type_support_t _RTCML1E1__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RTCML1E1,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irt_nav_msgs, msg, RTCML1E1)() {
  return &_RTCML1E1__type_support;
}
