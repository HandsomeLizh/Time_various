...
bool irt_nav_msgs__msg__residual__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("irt_nav_msgs.msg._residual.Residual", full_classname_dest, 35) == 0);
  }
  irt_nav_msgs__msg__Residual * ros_message = _ros_message;
  {  // header
  ...
  {  // outlier
    PyObject * field = PyObject_GetAttrString(_pymsg, "outlier");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->outlier = (Py_True == field);
    Py_DECREF(field);
  }
  {  // data
...
{
  /* NOTE(esteve): Call constructor of Residual */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("irt_nav_msgs.msg._residual");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Residual");
  ...
  {  // outlier
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->outlier ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "outlier", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
