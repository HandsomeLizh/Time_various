...
bool irt_nav_msgs__msg__satellite_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("irt_nav_msgs.msg._satellite_data.SatelliteData", full_classname_dest, 46) == 0);
  }
  irt_nav_msgs__msg__SatelliteData * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of SatelliteData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("irt_nav_msgs.msg._satellite_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SatelliteData");
