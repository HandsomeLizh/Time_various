...
class Metaclass_HybridStatistics(type):
    """Metaclass of message 'HybridStatistics'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'irt_nav_msgs.msg.HybridStatistics')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__hybrid_statistics
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__hybrid_statistics
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__hybrid_statistics
            cls._TYPE_SUPPORT = module.type_support_msg__msg__hybrid_statistics
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__hybrid_statistics
...
class HybridStatistics(metaclass=Metaclass_HybridStatistics):
    """Message class 'HybridStatistics'."""
